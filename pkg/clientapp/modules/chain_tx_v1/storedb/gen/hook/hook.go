...
// The ChainTxV1FactsFunc type is an adapter to allow the use of ordinary
// function as ChainTxV1Facts mutator.
type ChainTxV1FactsFunc func(context.Context, *gen.ChainTxV1FactsMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f ChainTxV1FactsFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.ChainTxV1FactsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.ChainTxV1FactsMutation", m)
}

// The ChainTxV1PaymentsFunc type is an adapter to allow the use of ordinary
// function as ChainTxV1Payments mutator.
type ChainTxV1PaymentsFunc func(context.Context, *gen.ChainTxV1PaymentsMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f ChainTxV1PaymentsFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.ChainTxV1PaymentsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.ChainTxV1PaymentsMutation", m)
}
