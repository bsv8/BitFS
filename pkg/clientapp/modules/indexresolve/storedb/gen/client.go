...
import (
	...
	"github.com/bsv8/BitFS/pkg/clientapp/modules/indexresolve/storedb/gen/migrate"
...
func (c *Client) Use(hooks ...Hook) {
	c.ProcIndexResolveRoutes.Use(hooks...)
}

// Intercept adds the query interceptors to all the entity clients.
// In order to add interceptors to a specific client, call: `client.Node.Intercept(...)`.
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.ProcIndexResolveRoutes.Intercept(interceptors...)
}
...
type (
	hooks struct {
		ProcIndexResolveRoutes []ent.Hook
	}
	inters struct {
		ProcIndexResolveRoutes []ent.Interceptor
	}
)
