...
// The Pool2of2V1EntriesFunc type is an adapter to allow the use of ordinary
// function as Pool2of2V1Entries mutator.
type Pool2of2V1EntriesFunc func(context.Context, *gen.Pool2of2V1EntriesMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f Pool2of2V1EntriesFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.Pool2of2V1EntriesMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.Pool2of2V1EntriesMutation", m)
}

// The Pool2of2V1SessionsFunc type is an adapter to allow the use of ordinary
// function as Pool2of2V1Sessions mutator.
type Pool2of2V1SessionsFunc func(context.Context, *gen.Pool2of2V1SessionsMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f Pool2of2V1SessionsFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.Pool2of2V1SessionsMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.Pool2of2V1SessionsMutation", m)
}
