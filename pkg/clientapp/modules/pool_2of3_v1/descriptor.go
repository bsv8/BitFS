...
import (
	...
	"github.com/bsv8/BitFS/pkg/clientapp/modules/pool_2of3_v1/storedb"
)

const ModuleIdentity = "pool_2of3_v1"
...
func ensureSchema(ctx context.Context, db *sql.DB) error {
	return storedb.EnsurePool2of3V1Schema(ctx, db)
}

func newStore(store moduleapi.Store) any {
	return newTradeStore(store)
}
