...
func dbListDemandQuotes(ctx context.Context, store *clientDB, f demandQuoteFilter) (demandQuotePage, error) {
	...
	if store.ent == nil {
		return demandQuotePage{}, fmt.Errorf("client db ent client is nil")
	}
	q := store.ent.BizDemandQuotes.Query()
	if f.DemandID != "" {
...
func dbGetDemandQuoteItem(ctx context.Context, store *clientDB, id int64) (demandQuoteItem, error) {
	...
	if store.ent == nil {
		return demandQuoteItem{}, fmt.Errorf("client db ent client is nil")
	}
	node, err := store.ent.BizDemandQuotes.Query().Where(bitfsbizdemandquotes.IDEQ(int(id))).Only(ctx)
	if err != nil {
...
func hydrateDemandQuoteArbitersEnt(ctx context.Context, store *clientDB, items []demandQuoteItem) error {
	if store == nil || store.ent == nil || len(items) == 0 {
		return nil
	}
	...
	nodes, err := store.ent.BizDemandQuoteArbiters.Query().
...
func dbListDirectTransferPoolsDebug(ctx context.Context, store *clientDB, f directTransferPoolFilter) (directTransferPoolPage, error) {
	...
	return clientDBValue(ctx, store, func(db sqlConn) (directTransferPoolPage, error) {
		where := ""
		args := make([]any, 0, 8)
		if f.SessionID != "" {
...
func dbGetDirectTransferPoolItemDebug(ctx context.Context, store *clientDB, sessionID string) (directTransferPoolItem, error) {
	...
	return clientDBValue(ctx, store, func(db sqlConn) (directTransferPoolItem, error) {
...
func dbListPurchases(ctx context.Context, store *clientDB, f purchaseFilter) (purchasePage, error) {
	...
	if store.ent == nil {
		return purchasePage{}, fmt.Errorf("client db ent client is nil")
	}
	q := store.ent.BizPurchases.Query()
	if f.DemandID != "" {
...
func dbGetPurchaseItem(ctx context.Context, store *clientDB, id int64) (purchaseItem, error) {
	...
	if store.ent == nil {
		return purchaseItem{}, fmt.Errorf("client db ent client is nil")
	}
	node, err := store.ent.BizPurchases.Query().Where(bitfsbizpurchases.IDEQ(int(id))).Only(ctx)
	if err != nil {
		if gen.IsNotFound(err) {
...
func dbSummarizeDemandPurchases(ctx context.Context, store *clientDB, demandID string) (purchaseDemandSummary, error) {
	...
	if store.ent == nil {
		return purchaseDemandSummary{}, fmt.Errorf("client db ent client is nil")
	}
	nodes, err := store.ent.BizPurchases.Query().Where(bitfsbizpurchases.DemandIDEQ(demandID)).All(ctx)
	if err != nil {
...
func dbListTxHistory(ctx context.Context, store *clientDB, f txHistoryFilter) (txHistoryPage, error) {
	...
	if store.ent == nil {
		return txHistoryPage{}, fmt.Errorf("client db ent client is nil")
	}
	q := store.ent.FactPoolSessionEvents.Query().Where(bitfsfactpoolsessionevents.EventKindEQ(PoolFactEventKindTxHistory))
	if f.EventType != "" {
...
func dbGetTxHistoryItem(ctx context.Context, store *clientDB, id int64) (txHistoryItem, error) {
	...
	if store.ent == nil {
		return txHistoryItem{}, fmt.Errorf("client db ent client is nil")
	}
	node, err := store.ent.FactPoolSessionEvents.Query().
...
func dbListGatewayEvents(ctx context.Context, store *clientDB, f gatewayEventFilter) (gatewayEventPage, error) {
	...
	if store.ent == nil {
		return gatewayEventPage{}, fmt.Errorf("client db ent client is nil")
	}
	q := store.ent.ProcGatewayEvents.Query()
	if f.GatewayPeerID != "" {
...
func dbGetGatewayEventItem(ctx context.Context, store *clientDB, id int64) (gatewayEventItem, error) {
	...
	if store.ent == nil {
		return gatewayEventItem{}, fmt.Errorf("client db ent client is nil")
	}
	node, err := store.ent.ProcGatewayEvents.Query().Where(bitfsprocgatewayevents.IDEQ(int(id))).Only(ctx)
	if err != nil {
		if gen.IsNotFound(err) {
