...
func callNodePoolInfo(ctx context.Context, rt *Runtime, peerID peer.ID) (poolcore.InfoResp, error) {
	return callNodePoolProto[poolcore.InfoReq, poolcore.InfoResp](ctx, rt, peerID, protocol.ID(contractprotoid.ProtoPoolV1Info), poolcore.InfoReq{})
}

func callNodePoolCreate(ctx context.Context, rt *Runtime, peerID peer.ID, req poolcore.CreateReq) (poolcore.CreateResp, error) {
	req.ClientID = ""
	return callNodePoolProto[poolcore.CreateReq, poolcore.CreateResp](ctx, rt, peerID, protocol.ID(contractprotoid.ProtoPoolV1Create), req)
}

func callNodePoolBaseTx(ctx context.Context, rt *Runtime, peerID peer.ID, req poolcore.BaseTxReq) (poolcore.BaseTxResp, error) {
	req.ClientID = ""
	return callNodePoolProto[poolcore.BaseTxReq, poolcore.BaseTxResp](ctx, rt, peerID, protocol.ID(contractprotoid.ProtoPoolV1BaseTx), req)
}
...
func callNodePoolPayConfirm(ctx context.Context, rt *Runtime, peerID peer.ID, req poolcore.PayConfirmReq) (poolcore.PayConfirmResp, error) {
	req.ClientID = ""
	return callNodePoolProto[poolcore.PayConfirmReq, poolcore.PayConfirmResp](ctx, rt, peerID, protocol.ID(contractprotoid.ProtoPoolV1PayConfirm), req)
}

func callNodePoolClose(ctx context.Context, rt *Runtime, peerID peer.ID, req poolcore.CloseReq) (poolcore.CloseResp, error) {
	req.ClientID = ""
	return callNodePoolProto[poolcore.CloseReq, poolcore.CloseResp](ctx, rt, peerID, protocol.ID(contractprotoid.ProtoPoolV1Close), req)
}
...
func callNodePoolSessionState(ctx context.Context, rt *Runtime, peerID peer.ID, spendTxID string) (poolcore.StateResp, error) {
	...
	return callNodePoolProto[poolcore.StateReq, poolcore.StateResp](ctx, rt, peerID, protocol.ID(contractprotoid.ProtoPoolV1SessionState), req)
}
